...
if(empty($_POST['Github'])){  $Github_input = "Github";  } 
	else {	$Github_input = 	$_POST['Github'];	}
	echo "DEBUG FORM $Name_input : $Github_input<br /> ";
?>
...
&nbsp;  Github<input type="text" name="Github" maxlength="20"> 
...
$query = "INSERT INTO stream.formdata (`id`, `ip`, `timein`, `Datein`, `Name`, `Github`) VALUES ('' ,'$str1','$str2','$str3','$str4','$str5');";
